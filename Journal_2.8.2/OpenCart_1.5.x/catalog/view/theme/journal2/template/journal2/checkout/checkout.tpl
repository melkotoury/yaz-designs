...
<script>
    ...
    function triggerLoadingOn() {
        ...
        if (ajax_calls === 1) {
            ...
            $('#journal-checkout-confirm-button, .checkout-register, .checkout-payment-form, .checkout-shipping-form, .checkout-cart, .confirm-section').addClass('checkout-loading');
        }
    }
    ...
    function triggerLoadingOff() {
        ...
        if (ajax_calls === 0) {
            ...
            $('#journal-checkout-confirm-button, .checkout-register, .checkout-payment-form, .checkout-shipping-form, .checkout-cart, .confirm-section').removeClass('checkout-loading');
        }
    }
