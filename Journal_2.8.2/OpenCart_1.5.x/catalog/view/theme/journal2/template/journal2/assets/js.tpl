...
Journal.galleryBarsDelay = parseInt('<?php echo $this->journal2->settings->get('hide_gallery_bars_after', '3000'); ?>', 10);
...
Journal.infiniteScrollLoadMoreItemsOffset = '<?php echo str_replace("'","\\'", $this->journal2->settings->get('infinite_scroll_load_more_items_offset', '0')); ?>';
...
if ($('html').hasClass('filter-on-mobile')) {
    $('.journal-sf').before($('<div class="open-filter" style="display:none"><?php echo $this->journal2->settings->get('filter_mobile_text'); ?></div>'));
