            ...
            <ul class="dropdown-menu">
                <?php foreach ($currencies as $currency): ?>
                    <?php if ($currency['symbol_left']): ?>
                        ...
                        <?php endif; ?>
                        <?php if ($type === 'full'): ?>
                        <li><a onclick="$(this).closest('form').find('input[name=\'currency_code\']').val('<?php echo $currency['title']; ?>'); $(this).closest('form').submit();"><?php echo $currency['symbol_left'];?> <?php echo $currency['title']; ?></a></li>
                        <?php endif; ?>
                    <?php else: ?>
                        <?php if ($type === 'symbol'): ?>
                        ...
                        <?php endif; ?>
                        <?php if ($type === 'full'): ?>
                        <li><a onclick="$(this).closest('form').find('input[name=\'currency_code\']').val('<?php echo $currency['title']; ?>'); $(this).closest('form').submit();"><?php echo $currency['title']; ?> <?php echo $currency['symbol_right']; ?></a></li>
                        <?php endif; ?>
                    <?php endif; ?>
                <?php endforeach; ?>
            </ul>
