...
<head>
<meta charset="UTF-8" />
<?php if ($this->journal2->settings->get('responsive_design', 'on') && $this->journal2->settings->get('pinch_zoom', 'off')): ?>
<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no">
<?php endif; ?>
<?php if ($this->journal2->settings->get('responsive_design', 'on') && !$this->journal2->settings->get('pinch_zoom', 'on')): ?>
