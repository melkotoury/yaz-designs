<div id="static-banners-<?php echo $module; ?>" class="static-banners-<?php echo $module_id; ?> box <?php echo $carousel ? 'journal-carousel' : ''; ?> <?php echo $carousel && $arrows === 'top' ? 'arrows-top' : ''; ?> static-banners <?php echo implode(' ', $disable_on_classes); ?> <?php echo isset($gutter_on_class) ? $gutter_on_class : ''; ?>" style="<?php echo isset($css) ? $css : ''; ?>">
    <div>
        <?php if ($title): ?>
        ...
        <div class="box-content">
            ...
            <?php foreach ($sections as $section): ?>
                <div class="static-banner swiper-slide <?php echo $grid_classes; ?>">
                    <?php if ($section['link']): ?>
            ...
            <script>
                (function () {
                    ...
                    var opts = {
                        ...
                        spaceBetween: 20,
                        pagination: <?php echo isset($bullets) && $bullets ? '$(\'#static-banners-' . $module . ' .swiper-pagination\')' : 'false'; ?>,
                        paginationClickable: true,
                        nextButton: <?php echo isset($arrows) && $arrows !== 'none' ? '$(\'#static-banners-' . $module . ' .swiper-button-next\')' : 'false'; ?>,
                        prevButton: <?php echo isset($arrows) && $arrows !== 'none' ? '$(\'#static-banners-' . $module . ' .swiper-button-prev\')' : 'false'; ?>,
