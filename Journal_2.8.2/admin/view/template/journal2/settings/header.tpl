...
<!--                    <span class="module-create-title">Slider Below Header<small>OFF will push the Revolution slider underneath the header. Slider must be placed in Top position on the Home layout.</small></span>-->
<!--                    <span class="module-create-option">-->
<!--                        <switch data-ng-model="settings.boxed_header_above">-->
...
<!--                            <switch-option key="compact">Compact</switch-option>-->
                        </switch>
                    </span>
                    <a href="#" target="_blank" class="journal-tip"></a>
                </li>
                ...
                <li data-ng-hide="settings.header_type == 'center' || settings.header_type == 'mega'">
                    ...
                    <span class="module-create-option">
                        ...
                        <j-opt-background data-ng-model="settings.logo_bg_image" data-bgcolor="true"></j-opt-background>
                    </span>
                    <a href="#" target="_blank" class="journal-tip"> </a>
                </li>
                ...
                <li>
                    ...
                    <span class="module-create-option">
                        ...
                        <j-opt-background data-ng-model="settings.header_bg_default" data-bgcolor="true"></j-opt-background>
                    </span>
                    <a href="#" target="_blank" class="journal-tip"> </a>
                </li>
                ...
                <li>
                    ...
                    <span class="module-create-option">
                        ...
                        <j-opt-background data-ng-model="settings.header_bg_pages" data-bgcolor="true"></j-opt-background>
                    </span>
                    <a href="#" target="_blank" class="journal-tip"> </a>
                </li>
                ...
                <li data-ng-hide="settings.logo_on_phone == 'off'">
                    <span class="module-create-title">Logo Area Height on Phone</span>
                    <span class="module-create-option">
                ...
                <accordion-group is-open="true">
                    ...
                    <li data-ng-show="settings.sticky_header === '1' && settings.sticky_header_style === 'menu' && settings.boxed_header === '1'">
                    ...
                    <li data-ng-show="settings.sticky_header == '1'">
                        ...
                        <j-opt-background data-ng-model="settings.header_bg_sticky" data-bgcolor="true"></j-opt-background>
                        </span>
                        <a href="#" target="_blank" class="journal-tip"> </a>
                    </li>
                    <li data-ng-show="settings.sticky_header == '1'">
        ...
        <accordion-group is-open="accordion.accordions[3]">
            ...
            <ul class="module-create-options">
                ...
                <li data-ng-show="settings.language_display == 'full' || settings.currency_display == 'full' || settings.language_display_mobile == 'full' || settings.currency_display_mobile == 'full'">
                    <span class="module-create-title">Full Text Font</span>
                    <span class="module-create-option">
