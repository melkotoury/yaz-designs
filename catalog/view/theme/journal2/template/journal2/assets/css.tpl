...
<?php if($this->journal2->settings->get('product_grid_box_shadow', 'none') === 'default' && $this->journal2->settings->get('product_grid_shadow', 'hover') === 'hover'): ?>
.product-grid-item:hover .product-wrapper{
  box-shadow: 0 0 15px rgba(0, 0, 0, 0.30);
}
<?php endif; ?>

<?php if($this->journal2->settings->get('product_grid_box_shadow', 'none') === 'default' && $this->journal2->settings->get('product_grid_shadow', 'hover') === 'always'): ?>
...
<?php if($this->journal2->settings->get('product_grid_box_shadow', 'none') === 'custom' && $this->journal2->settings->get('product_grid_shadow', 'hover') === 'always'): ?>
.product-grid-item  .product-wrapper{
  <?php echo $this->journal2->settings->get('product_grid_shadow_custom');?>;
}
<?php endif; ?>

<?php if($this->journal2->settings->get('product_grid_box_shadow', 'none') === 'custom' && $this->journal2->settings->get('product_grid_shadow', 'hover') === 'hover'): ?>
.product-grid-item:hover .product-wrapper{
  <?php echo $this->journal2->settings->get('product_grid_shadow_custom');?>;
}
<?php endif; ?>
...
<?php if($this->journal2->settings->get('carousel_product_grid_box_shadow', 'inherit') === 'custom' && $this->journal2->settings->get('carousel_product_grid_shadow', 'hover') === 'hover'): ?>
.journal-carousel .product-grid-item:hover .product-wrapper{
  <?php echo $this->journal2->settings->get('carousel_product_grid_shadow_custom');?>;
}
<?php endif; ?>

<?php if($this->journal2->settings->get('carousel_product_grid_box_shadow', 'inherit') === 'custom' && $this->journal2->settings->get('carousel_product_grid_shadow', 'hover') === 'always'): ?>
...
<?php if($this->journal2->settings->get('cs_product_grid_box_shadow', 'inherit') === 'custom' && $this->journal2->settings->get('cs_product_grid_shadow', 'hover') === 'hover'): ?>
.custom-sections .product-grid-item .product-wrapper:hover{
  <?php echo $this->journal2->settings->get('cs_product_grid_shadow_custom');?>;
}
<?php endif; ?>

<?php if($this->journal2->settings->get('cs_product_grid_box_shadow', 'inherit') === 'custom' && $this->journal2->settings->get('cs_product_grid_shadow', 'hover') === 'always'): ?>
...
<?php if($this->journal2->settings->get('mega_header_align', 'center') === 'center'): ?>
...
<?php if($this->journal2->settings->get('mega_menu_animate', 'on') === 'off'): ?>
...
@media only screen and (max-width:<?php echo $this->journal2->settings->get('site_width', 1024); ?>px){
.header-notice > div{
...
@media only screen and (min-width: 760px){
#column-left + #content {
  margin-left: <?php echo $this->journal2->settings->get('left_column_width', 240); ?>px;
}
#column-right + #content {
  margin-right: <?php echo $this->journal2->settings->get('right_column_width', 240); ?>px;
}
...
@media only screen and (min-width:760px) and (max-width:980px) {
#column-left {
  width: <?php echo $this->journal2->settings->get('left_column_width_tablet', 240); ?>px;
}
#column-right{
  width: <?php echo $this->journal2->settings->get('right_column_width_tablet', 240); ?>px;
}
#column-left + #content {
  margin-left: <?php echo $this->journal2->settings->get('left_column_width_tablet', 240); ?>px;
}
#column-right + #content {
  margin-right: <?php echo $this->journal2->settings->get('right_column_width_tablet', 240); ?>px;
}
#column-left + #column-right + #content{
  margin-left: <?php echo $this->journal2->settings->get('left_column_width_tablet', 240); ?>px;
  margin-right: <?php echo $this->journal2->settings->get('right_column_width_tablet', 240); ?>px;
...
html[dir="rtl"].extended-layout #column-left + #content {
  margin-right: <?php echo $this->journal2->settings->get('left_column_width', 240); ?>px;
  margin-left: 0;
...
html[dir="rtl"] #column-right + #content {
  margin-left: <?php echo $this->journal2->settings->get('right_column_width', 240); ?>px;
  margin-right: 0;
}
...
html[dir="rtl"] #column-left + #content {
  margin-right: <?php echo $this->journal2->settings->get('left_column_width_tablet', 240); ?>px;
  margin-left:0;
}
html[dir="rtl"] #column-right + #content {
  margin-left: <?php echo $this->journal2->settings->get('right_column_width_tablet', 240); ?>px;
  margin-right:0;
}
html[dir="rtl"] #column-left + #column-right + #content{
  margin-right: <?php echo $this->journal2->settings->get('left_column_width_tablet', 240); ?>px;
